...
export const siteInfo = {
  ...
  address: 'Piphup Thmey, Chamkar Doung, 12401 Phnom Penh',
  photo: 'https://cms.sivann.com/wp-content/uploads/2024/02/Mister-Sivann-Profile-Web-1953x2560-_2024_small-size.png',
  // Real site logo, used in both SiteHeader and SiteFooter. Served
  // directly from cms.sivann.com (the sivann.com-origin copy 404s now
  // that sivann.com itself serves the Next.js frontend, not WordPress).
  logo: 'https://cms.sivann.com/wp-content/uploads/2022/07/sivann-logo-home.png',
  logoFooter: 'https://cms.sivann.com/wp-content/uploads/2020/02/sivann-logo-home-e1581091401147.png',
  social: {
    // These match the exact links published in the live footer widget
    // (cms.sivann.com/blog "Follow Us" panel).
    facebook: 'https://www.facebook.com/mister.sivann/',
    twitter: 'http://twitter.com/_sivann',
    youtube: 'https://www.youtube.com/channel/UCTG49lZaikw9CD9bBvRo6Ng?sub_confirmation=1',
    linkedin: 'https://www.linkedin.com/company/mister-sivann/',
    instagram: 'https://www.instagram.com/mister.sivann/',
    telegram: 'https://t.me/mistersivann/',
    rss: 'https://cms.sivann.com/feed/',
  },
};

// Content for the "About the Art of Non-ostentatious" footer widget
// (first column of the site-wide footer, present on every page).
export const footerAbout = {
  heading: 'About The Art of Non-Ostentatious',
  image: 'https://cms.sivann.com/wp-content/uploads/2018/02/the-art-of-non-ostentatious-ano-300x94.jpg',
  text: 'The key theme of this topic, the Art of Non-Ostentatious (ANO) for my blog, is all about the non-ostentatious life. It can be defined as "a man enriched a man indeed" or "a need of self-enrichment in a practical life, concentrate on (positively), and get work done.',
  // Post 1212 on cms.sivann.com is "The Art of Non-Ostentatious (ANO)" --
  // the same article the original footer widget's "VIEW MORE" links to.
  viewMoreHref: '/blog/1212',
};

// Quick-links footer widget (fourth column) -- mirrors the original
// site's footer menu, including its decorative photo.
export const footerLinks = [
  { label: 'Welcome Notes', href: '/welcome-notes' },
  { label: 'Philosophy', href: '/philosophy' },
  { label: 'Khmer', href: 'https://cms.sivann.com/?page_id=66' },
  { label: 'Portfolio', href: '/portfolio' },
  { label: 'Katy Studio', href: 'https://cms.sivann.com/katystudio/' },
];
export const footerImage = 'https://cms.sivann.com/wp-content/uploads/2020/02/the-art-of-non-ostentatious-ano.jpg';
...
export const experience = [
  {
    heading: 'Founder, Katy Studio',
    company: 'Katy Studio',
    location: 'Phnom Penh, Cambodia',
    from: 'Aug 2026',
    to: 'Present',
    duration: 'PRESENT',
    description: `<p>Founded Katy Studio as the execution arm that turns strategy into digital reality — design, coding, and marketing under one roof, faster and leaner than a traditional agency. Built Blugital end-to-end as proof of capability, and now build every platform across the group, including BongVann, the BongVann Ads infrastructure, Vannpreneur, and Vanndemy.</p>`,
  },
  {
    heading: 'Senior Manager, Marketing Center & Growth Manager',
    company: 'Metathought',
    location: 'Phnom Penh, Cambodia',
    from: 'Jun 2024',
    to: 'Jul 2026',
    duration: '(2 YEARS 1 MONTH)',
    description: `<p>Leading company-wide revenue growth as the driving force behind sales strategy and execution. Built and coached high-performing sales teams, sharpened conversion rates, and deepened customer engagement — turning data into decisions that move the business forward.</p>`,
  },
  {
...
<p><a href="https://sivann.com/portfolio/career/" target="_blank" rel="noopener noreferrer">View more in Portfolio</a> | <a href="https://www.linkedin.com/in/tesivann/" target="_blank" rel="noopener">LinkedIn Profile</a></p>`,
  },
  {
    ...
    description: `<p>Independent creative and digital consultant since university, through Katy Studio — branding, UX/UI, and startup strategy for clients who needed clarity fast, before evolving Katy Studio into a full studio in 2026.</p>`,
  },
  {
...
// Content for the standalone /welcome-notes page (mirrors the original
// site's "Welcome Notes" page -- a personal introduction from the author).
export const welcomeNotes = {
  eyebrow: "Message from the Website Blog's Publisher and Author",
  quote: '"If you never do it, you won’t ever know how much it is possible."',
  quoteAuthor: 'TE Sivann',
  stats: [
    { label: 'Articles', value: '200+' },
    { label: 'Subscribers', value: '1K+' },
    { label: 'Years Experience', value: '15+' },
...
Sivann.`,
  cards: [
    { title: 'Who Am I?', text: 'I am Sivann, who developed this website, and I do as a Blogger & Content Writer / Web & Marketing Innovator. You can get to know about me further by reading in my profile or the rest contents in the website. Nice to see you, welcome!' },
    { title: 'My Dream/Wishes Checklist', text: 'To realize my beautiful dream, I have to withstand the psychological endurance of various kinds of setbacks in addition to having the necessary knowledge and talents. It’s not just about dreams, but it’s the goals to make my life.' },
    { title: 'May I Help You More?', text: 'Something you may find fascinating in the Art of Non-Ostentatious, where is a room for everyone to grow. Then I am here to help you and we grow together. With the essence of philosophy & disciplines to fine your solutions.' },
    { title: 'The Art of Non-ostentatious', text: 'The key theme of this topic for my blog, the Art of Non-Ostentatious (ANO), is all about the non-ostentatious life. It can be defined as "a need of self-enrichment in practical life, concentrate on, get more work done. Enjoy it.' },
    { title: 'My Day My Quotes', text: 'There are about the essence of the philosophy of the world-famous quotes and some must-to disciplines that I think I should follow, to consider, and it may help me grow more or make extremely different.' },
    { title: 'Monsters in Life', text: 'Everyone may differ from each other, but we may have the same monsters in mind and they’re very very small we may careless about. Be yourself superhero, defeat all little monsters on a road to your dream, be your own life.' },
  ],
  cta: {
    heading: 'The 100% Free guide for your Awesome Life plan guide!',
    text: 'You might be obtaining a strong enough way to plan your life, but to whom may not yet set your precise plan or don’t know where to start. This might be a helpful instruction to assist you even it’s a bit take time and need more effort to learn, understand, apply it into your process.',
    button: 'Get Started Now',
  },
};

// Content for the standalone /philosophy page.
export const philosophy = {
  eyebrow: 'The Essence of Philosophy & Disciplines in The Art of Non-ostentatious',
  intro: 'If you never do it, you won’t ever know how much it is possible.',
  quotes: [
    { text: 'You don’t have to live your life the way other people expect.', author: 'Chris Guillebeau' },
    { text: 'Do not, for one repulse, forgo the purpose that you resolved to effort.', author: 'William Shakespeare' },
    { text: 'If you don’t do it, nothing is possible. If you do it, at least, you have the hope that there’s a chance.', author: 'Jack MA' },
  ],
  essence: [
    { en: 'Adhere to your ideal, firmly believe your future, strongly determine your action, and passionately realize your dream.', zh: '坚持理想，坚信未来，坚强行动，坚定实现梦想。' },
    { en: 'No matter how wonderful your idea is, if you cannot make it happens, it is still a dream, not your reality.', zh: '无论你的想法是多么的美妙，当你无法把它实现的时候，它仍然是个梦，而不是你的现实。' },
    { en: 'Once you adhere to your passion and strong commitment, you will never, never, ever give it up.', zh: '' },
    { en: 'LOVE, is a kind of persistent and belief, to change your LIFE. So, please try to care and love more people around you.', zh: '' },
    { en: 'Happiness, it is not getting all what you want. Yet, it is enjoying all what you have.', zh: '' },
  ],
  disciplines: {
    heading: 'The Disciplines that make extremely differentiate',
    intro: 'The 5 disciplines that make the extremely differentiate, I have learned from work (Ken MATSUMURA), previously.',
    items: [
...
// Content for the standalone /contact page.
export const contactPage = {
  eyebrow: 'Get in touch',
  intro: 'Hello, I am ready to hear from you about everything you would like to share with me, or the questions and recommendations to me as well. So, please keep in touch and don’t hesitate to contact me. Thank you!',
};
