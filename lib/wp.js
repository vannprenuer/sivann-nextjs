...
//
// Set NEXT_PUBLIC_WP_API_URL (e.g. https://sivann.com/wp-json) in .env.local
// once the WordPress backend is live again, and these functions switch from
// the local seed data (lib/content.js) to real, live content automatically.
